...
class PartyCog(commands.Cog):
    ...
    @commands.command(name="ping", help="Checks bot listens and responds.")
        ...
        if is_bumble(author):
            sample = random.choice(
                [
                    ...
                    f"{author} is talking about stabbing {random.choice(list(board.powers)).name} again",
                    ...
                    f"{random.choice(list(board.powers)).name} is in a perfect position to stab {author}",
                    ".bumble",
                ]
            )
