...
class TestParseEditState(unittest.TestCase):
    ...
    def test_set_province_owner(self):
        ...
        self.assertEqual(b.board.get_province("Warsaw").owner, b.players["Austria"], "Failed to set owner of Warsaw to Austria")
    ...
    def test_create_dislodged_unit(self):
        ...
        self.assertEqual(a_serbia.player, b.players["Germany"], "Created dislodged unit in Serbia does not belong to Germany")
        ...
        self.assertEqual(f_bulgaria.player, b.players["Austria"], "Created dislodged unit in Bulgaria_ec does not belong to Austria")
    ...
    def test_dislodge_unit(self):
        ...
        self.assertEqual(p_munich.dislodged_unit.player, b.players["Germany"], "Dislodged unit in Munich does not belong to Germany")
    ...
    def test_make_units_claim_provinces(self):
        ...
        self.assertNotEqual(p_tunis.owner, b.players["Italy"], "Tunis should not be owned by Italy, as it is a supply center")
        ...
        self.assertEqual(p_tunis.owner, b.players["Italy"], "Tunis should be owned by Italy after claiming all supply centers")